...
function HomePage() {
return (
    <div className="relative w-full">        <div className="flex flex-col items-center px-4 sm:px-8 md:px-16 lg:hidden">
            <Animation classes="" style={{ width: "100%" }}>
                <div className="flex flex-col items-center w-full space-y-8">
                    ...
                    <div className="mt-8">
                        <a href="https://hcb.hackclub.com/donations/start/global-health-literacy-outreach">
                            <button 
                                className="animate-bounce bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg transition w-48 sm:w-64 text-center">
                                Donate Now
                            </button>
                        </a>
                    </div>
        ...
        <div className="hidden lg:flex flex-col items-center px-16">
            <Animation classes="" style={{ width: "100%" }}>
                ...
                <a href="https://hcb.hackclub.com/donations/start/global-health-literacy-outreach">
                    <button 
                        className="animate-bounce bg-blue-500 hover:bg-blue-700 text-white font-bold py-3 px-8 rounded-full text-lg transition mt-4 ml-4 w-48 sm:w-64 text-center">
                        Donate Now
                    </button>
                </a>
                </div>
